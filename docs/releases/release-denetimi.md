...
Git geçmişinde ve GitHub Releases yüzeyinde `v2.2.39` bulunur. `v2.2.40`, başlangıç denetimi başarısız olduğunda gizlenen güncelleme düğmesini kalıcı bir elle-denetim yüzeyine dönüştüren yeni adaydır; tag, GitHub release ve public asset sonucu workflow tamamlanmadan oluşmuş sayılmaz.

### v2.2.40 Yerel Aday Kapısı

- Kaynak, testler ve üç Windows executable sürümü `2.2.40` olarak hizalanır.
- Başarılı güncelleme bulma ve tekrarlanan GitHub HTTP 503 hatası gerçek WPF senaryolarıyla sınanır; hata sonrasında `Denetle` düğmesi görünür kalmalıdır.
...
- v2.2.40, v2.2.34 dahil eski sürümlerde başlangıç güncelleme isteği başarısız olduğunda kullanıcının elle tekrar deneyebileceği düğmenin de gizlenmesini düzeltir.
...
| --- | --- | --- | --- | --- |
| `v2.2.40` | Yerel aday | Workflow bekleniyor | Tag sonrası iki CI runner'ını, release workflow'unu ve 4 public asset'i doğrula | Güncelleme denetimi hata sonrası görünür ve tekrar denenebilir kalır; portable/release kapıları korunur. |
| `v2.2.39` | Yayında | 4 asset; public digest ve SHA-256 doğrulandı | v2.2.40 ile üstlen | Self-contained ZIP, Unicode/boşluk yolu, manifest, x64 PE ve gerçek başlangıç self-test kapıları. |
