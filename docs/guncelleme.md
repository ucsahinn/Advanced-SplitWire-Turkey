...
Yeni elle kurulumlarda klasör adını sabit `Astral` tutmak önerilir. `Astral-2.2.38-win-x64` veya `2.2.38` gibi sürüm adlı klasörlerden çalıştırma desteklenir, ancak Astral bu durumu tanılama paketine yazar ve kullanıcı onayı olmadan klasör taşımaz.
